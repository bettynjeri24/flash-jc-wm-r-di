package com.ekenya.rnd.walletbaseapp.tollo
...
import com.ekenya.rnd.walletbaseapp.tollo.di.DaggerAppComponent
...
class WalletSolutionApp: BaseApplication(), HasActivityInjector, HasSupportFragmentInjector {
