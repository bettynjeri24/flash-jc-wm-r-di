...
public class EthiopicCalendar {
	...
	*/
	...
	public static final int JD_EPOCH_OFFSET_AMETE_MIHRET = 1723856; // ዓ/ም
	...
	*/
	...
	public EthiopicCalendar(Calendar cal) {
		this.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH)+1, cal.get(Calendar.DAY_OF_MONTH));
	}
	public EthiopicCalendar(int year, int month, int day, int era ) throws ArithmeticException {
	...
	** ********************************************************************************
	*/
	public void set( int year, int month, int day, int era ) throws ArithmeticException {
		this.year = year;
		this.month = month;
		this.day = day;
		this.setEra( era );
	...
	public void setEra ( int era ) throws ArithmeticException {
	...
	** ********************************************************************************
	*/
	public int[] ethiopicToGregorian( int era ) throws ArithmeticException {
		if (! isDateSet() ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
		return ethiopicToGregorian( this.year, this.month, this.day, era );
	}
	public int[] ethiopicToGregorian( int year, int month, int day, int era )  throws ArithmeticException {
		setEra( era );
	...
	public int[] ethiopicToGregorian() throws ArithmeticException {
		if ( dateIsUnset ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
	...
	public int[] gregorianToEthiopic() throws ArithmeticException {
		if ( dateIsUnset ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
	...
	*/
	...
	public int ethiopicToJDN() throws ArithmeticException {
		if ( dateIsUnset ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
	...
	public int ethiopicToJDN( int era ) throws ArithmeticException {
		return ethiopicToJDN( year, month, day, era );
	}
	public int ethiopicToJDN( int year, int month, int day, int era )  throws ArithmeticException {
	...
	** ********************************************************************************
	*/
	public int[] copticToGregorian() throws ArithmeticException {
		if ( dateIsUnset ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
	...
	public int[] gregorianToCoptic() throws ArithmeticException {
		if ( dateIsUnset ) {
			throw ( new ArithmeticException( "Unset date." ) );
		}
