...
import com.ekenya.rnd.tijara.databinding.FragmentCapturePhotoBinding
        ...
        binding.apply {
            ...
            btnContinue.setOnClickListener {
                if (!::frontFile.isInitialized) {
                    ...
                    toastyInfos("please take back ID photo")
                } else {
                    viewModel.frontIdPhoto=frontFile
                    viewModel.backIdPhoto=backFile
                    findNavController().navigate(R.id.action_capturePhotoFragment_to_selfieFragment)
                }
            }
