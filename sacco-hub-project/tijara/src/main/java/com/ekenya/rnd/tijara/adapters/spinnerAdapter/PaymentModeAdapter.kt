...
import com.ekenya.rnd.tijara.network.model.PaymentMode

import kotlinx.android.synthetic.main.gender_dropdown_item_list.view.*

class PaymentModeAdapter(context: Context, list: List<PaymentMode>) : ArrayAdapter<PaymentMode>(context, 0, list) {
