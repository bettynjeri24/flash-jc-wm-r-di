...
class StandingOrderSpAdapter(context: Context, list: List<StandingOrderData>) : ArrayAdapter<StandingOrderData>(context, 0, list) {
    ...
    private fun createView(position: Int, recycledView: View?, parent: ViewGroup): View {
        ...
        view.tv_gender.text=name!!.toAccount
