...
class FrequenyAdapter(context: Context, list: List<StandingOrderFrequenyData>) : ArrayAdapter<StandingOrderFrequenyData>(context, 0, list) {
    ...
    private fun createView(position: Int, recycledView: View?, parent: ViewGroup): View {
        ...
        view.tv_gender.text=name!!.label
