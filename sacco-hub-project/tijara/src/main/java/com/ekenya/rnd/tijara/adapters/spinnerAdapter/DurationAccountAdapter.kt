...
import com.ekenya.rnd.tijara.network.model.ParkingDuration
...
class DurationAccountAdapter(context: Context, list: List<ParkingDuration>) : ArrayAdapter<ParkingDuration>(context, 0, list) {
    var name1=""
    ...
    private fun createView(position: Int, recycledView: View?, parent: ViewGroup): View {
        ...
        val formatNmae= name?.description?.let { camelCase(it) }
