...
public class MainPrinterModuleActivity extends Activity implements View.OnClickListener,
    ...
    public void onClick(final View v) {
        int id = v.getId();
        if (id == R.id.buttonOpenFromDeviceStorage) {
            openFromDeviceStorage();
        } else if (id == R.id.buttonOpenPrinter) {
            openPrinter();
        } else if (id == R.id.buttonPrint) {
            print();
        } else if (id == R.id.buttonClosePrinter) {
            closePrinter();
        }
    }
    ...
    public void onCheckedChanged(final RadioGroup group, final int checkedId) {
        if (checkedId == R.id.radioDeviceStorage) {
            openFromDeviceStorageButton.setEnabled(true);
        } else if (checkedId == R.id.radioProjectResources) {
    ...
    private void print() {
        ...
        try {
            ...
            int checkedRadioButtonId = openRadioGroup.getCheckedRadioButtonId();
            if (checkedRadioButtonId == R.id.radioDeviceStorage) {
            ...
            } else if (checkedRadioButtonId == R.id.radioProjectResources) {
