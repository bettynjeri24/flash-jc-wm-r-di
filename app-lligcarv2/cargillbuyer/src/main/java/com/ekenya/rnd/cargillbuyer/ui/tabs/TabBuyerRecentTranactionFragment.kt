...
import com.ekenya.rnd.cargillbuyer.databinding.FragmentBuyerRecentTranactionTabBinding
...
class TabBuyerRecentTranactionFragment :
    BaseCommonBuyerCargillDIFragment<FragmentBuyerRecentTranactionTabBinding>(
        FragmentBuyerRecentTranactionTabBinding::inflate
    ) {
    @Inject
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvViewAll.setOnClickListener {
            findNavController().navigate(R.id.buyerRecentTranactionFragment)
        }
    }
