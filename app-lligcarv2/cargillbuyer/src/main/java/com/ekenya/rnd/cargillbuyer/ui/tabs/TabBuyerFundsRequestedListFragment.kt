...
import com.ekenya.rnd.cargillbuyer.databinding.FragmentFundsRequestedListBuyerTabBinding

import com.ekenya.rnd.cargillbuyer.ui.buyerprofile.BuyerCargillViewModel
import com.ekenya.rnd.cargillbuyer.ui.buyerprofile.fundrequest.BuyerTopUpRequestsAdatper
...
class TabBuyerFundsRequestedListFragment :
    BaseCommonBuyerCargillDIFragment<FragmentFundsRequestedListBuyerTabBinding>(
        FragmentFundsRequestedListBuyerTabBinding::inflate
    ) {
    @Inject
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvViewAll.setOnClickListener {
            findNavController().navigate(R.id.buyerFundsRequestedListFragment)
        }
    }
