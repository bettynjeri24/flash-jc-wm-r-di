...
import com.ekenya.rnd.cargillcoop.databinding.FragmentApproveEvalueRequestBinding
...
class ApproveEvalueRequestFragment :
    BaseCommonCargillCoopFragment<FragmentApproveEvalueRequestBinding>(
        FragmentApproveEvalueRequestBinding::inflate
    ) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        setToolbarTitle(
            resources.getString(com.ekenya.rnd.common.R.string.evalue_booking),
            resources.getString(com.ekenya.rnd.common.R.string.aprove_evalue_sbbt),
