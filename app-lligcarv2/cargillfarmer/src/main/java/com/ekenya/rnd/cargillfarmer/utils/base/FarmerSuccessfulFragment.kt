package com.ekenya.rnd.cargillfarmer.utils.base
...
class FarmerSuccessfulFragment : DaggerFragment() {
    ...
    private fun setUpUI() {
        binding.apply {
            recyclerViewDetails.apply {
                ...
                val contentHashMap: HashMap<String, String> = arguments?.getSerializable("content") as HashMap<String, String>
