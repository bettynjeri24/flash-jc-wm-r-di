package com.ekenya.rnd.tmd.ui.fragments.login.lockscreen
...
class LockScreenAuthenticator(private val activity: Activity, private val lockScreenCallback: LockScreenCallback) {
