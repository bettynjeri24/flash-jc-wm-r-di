package com.ekenya.rnd.tmd.ui.fragments.new_pin
...
class NewPinFragment : BaseDaggerFragment() {
    ...
    private fun setUpUI() {
        binding.apply {
            ...
            textViewSubTitle.text = "Create a new Pin"
...
//                textViewVoiceId.setBiometricsLauncher()
    ...
    private fun simulateLoading() {
        lifecycleScope.launch {
            simulateSearching()
            findNavController().navigate(R.id.action_newPinFragment_to_confirmNewPinFragment)
        }
    }
