package com.ekenya.rnd.tmd.ui.custom_views
...
class DashboardIndicatorLayout : LinearLayout {
    ...
    private fun updateIndicators() {
        ...
        for (i in 0 until indicatorCount) {
            ...
            layoutParams.setMargins(px(3.5f), px(3.5f), px(3.5f), px(3.5f))
            indicator.layoutParams = layoutParams
            indicator.setBackgroundResource(R.drawable.dashboard_indicator_unselected_cards)
        ...
        if (position in 0..indicatorCount) {
            ...
            for (index in 0 until indicatorCount) {
                ...
                if (index == selectedPosition) {
                    indicator.setBackgroundResource(R.drawable.dashboard_indicator_selected_cards)
                } else {
                    indicator.setBackgroundResource(R.drawable.dashboard_indicator_unselected_cards)
                }
            }
