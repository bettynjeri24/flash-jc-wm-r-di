package com.ekenya.rnd.tmd.ui.fragments.login.speechrecognition.circle_progress
...
class CircleProgressBarAuth(context: Context, attrs: AttributeSet) : View(context, attrs) {
     ...
     * so don't call the [CircleProgressBarAuth.setProgress] directly within this method.
     *
