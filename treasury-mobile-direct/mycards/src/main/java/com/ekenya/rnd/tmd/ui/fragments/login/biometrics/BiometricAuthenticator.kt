package com.ekenya.rnd.tmd.ui.fragments.login.biometrics
...
class BiometricAuthenticator(
    ...
    private var executor: Executor = ContextCompat.getMainExecutor(activity.applicationContext)
    ...
    fun authenticate(biometricAllowedAuth: Int) {
        checkBiometricsSupport(biometricAllowedAuth)
    }

    // Checks the state of the biometrics using biometric manager
    private fun checkBiometricsSupport(biometricAllowedAuth: Int) {
        ...
        when (biometricManager.canAuthenticate()) {
            BiometricManager.BIOMETRIC_SUCCESS -> {
                ...
                val promptInfo = BiometricPrompt.PromptInfo.Builder()
                    ...
                    .setAllowedAuthenticators(biometricAllowedAuth)
    ...
    companion object {
        ...
        private const val KEY_NAME: String = "AndroidKeyStore"
    }
}
