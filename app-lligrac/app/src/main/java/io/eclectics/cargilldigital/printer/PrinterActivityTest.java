...
public class PrinterActivityTest extends AppCompatActivity implements View.OnClickListener,
    ...
    private void onActivityAction() {
        try {
            ...
            List<PrinterDataAdapter.PrinterData> plist = DemoDummyData.INSTANCE.printListx(this);
            for(PrinterDataAdapter.PrinterData printerData:plist){
                Log.e("data",printerData.getPrintRow());
            }
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(PrinterActivityTest.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
    ...
    private void getPermission() {
        ActivityCompat.requestPermissions(PrinterActivityTest.this,
    ...
    private static String[] getFooter() {
        return new String[]{
                PrinterActivityTest.getSeparator("<<SEPARATOR>>"),
                "\n",
    ...
    private static String[] getHeader( String copyOwner) {
        return new String[]{
                PrinterActivityTest.centeredText("***** " + copyOwner + " *****") + "\n",
                "\n",
                PrinterActivityTest.centeredText("Cargill Digital Payment") + "\n",
                PrinterActivityTest.centeredText("Code: "+ UtilPreference.Companion.getSectionCode()) + "\n",
                "\n",
