...
import io.eclectics.cargilldigital.databinding.FragmentScanffPaymentQrcodeBinding
import io.eclectics.cargilldigital.utils.ToolBarMgmt
import javax.inject.Inject
import kotlin.properties.Delegates

@AndroidEntryPoint
class ScanFFPaymentQRCode : Fragment() {
    ...
    private var _binding: FragmentScanffPaymentQrcodeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentScanffPaymentQrcodeBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mainLayoutToolbar.imgQRCode.setOnClickListener {
            findNavController().navigate(R.id.nav_ffsampleqr)
            /*val result = "TransID: result are necess"
